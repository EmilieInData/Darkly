...
But today it is considered cryptographically broken and is no longer recommended for security because many databases of known hashes exist
and it has become very easy to decrypt MD5 hashes.
